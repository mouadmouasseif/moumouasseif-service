...
<body id="wrapper">
	...
	<nav id="mm-menu" class="mm-menu">
		...
		<ul class="mm-menu__items">
			...
			<li class="mm-menu__item">
			<a class="mm-menu__link" href="service.html">
					<span class="mm-menu__link-text"><i class="fa fa-inbox"></i> Service</span>
				  </a>
			</li>
			<li class="mm-menu__item">
	...
	<script>
    var url = 'https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?6681';
  ...
  "brandSetting":{
      "brandName":"Mouasseif Store",
      "brandSubTitle":"Typically replies within a day",
      "brandImg":"",
      "welcomeText":"Hi there!\nHow can I help you?",
      "messageText":"I'm interessed white {{page_link}}",
      "backgroundColor":"#0a5f54",
      "ctaText":"Start Chat",
      "borderRadius":"25",
      "autoShow":true,
      "phoneNumber":"212689642894"
  }
};
    s.onload = function() {
